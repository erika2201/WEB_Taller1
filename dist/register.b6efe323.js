...
})({"jhtIb":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
if (registerUserForm != null) registerUserForm.addEventListener("submit", async (e)=>{
    ...
    const userRegistered = await _auth.registerUser(_app.auth, newUser);
    await _auth.addUserToDatabase(_app.db, userRegistered.uid, newUser);
    //Change according to admin status
    _auth.onAuthStateChanged(_app.auth, async (user)=>{
        if (user) {
            const uid = user.uid;
            let userLogged = [];
            const firebaseUser = await _getUser.getUser(uid);
            userLogged = firebaseUser;
            if (userLogged.isAdmin) location.href = "./createProduct.html";
...
if (loginUserForm != null) loginUserForm.addEventListener("submit", (e)=>{
    ...
    _auth.loginUser(_app.auth, email, password);
...
},{"./app":"bAabt","../functions/auth":"cEvP7","./getUser":"f6zaq","firebase/auth":"drt1f"}],"cEvP7":[function(require,module,exports) {
...
parcelHelpers.export(exports, "onAuthStateChanged", ()=>_auth.onAuthStateChanged
);
...
async function registerUser(auth, { email , password  }) {
    try {
        ...
        if (e.code === "auth/missing-email") alert("Te falta ingresar un correo");
...
},{"firebase/auth":"drt1f","firebase/firestore":"cJafS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"f6zaq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./app":"bAabt","firebase/firestore":"cJafS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jhtIb","cvZoU"], "cvZoU", "parcelRequire2c23")
