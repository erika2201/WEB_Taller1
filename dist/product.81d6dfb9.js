...
})({"i4PLm":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3bd1028a81d6dfb9";
...
},{}],"7Um7J":[function(require,module,exports) {
var _app = require("./app");
var _auth = require("firebase/auth");
var _getProduct = require("./getProduct");
var _cartJs = require("../functions/cart.js");
...
function renderProduct(product) {
    ...
    productInfoSection.innerHTML = `
        ...
        <p class="product__price">${_utils.currencyFormat(product.price)}</p>
        <button class="product__addCart">Añadir al carrito</button>`;
    if (product.image.length > 1) createGallery(product.image);
    ...
    productCartBtn.addEventListener("click", async (e)=>{
        ...
        if (userLogged) await _cartJs.createFirebaseCart(_app.db, userLogged.uid, cart);
    });
}
function createGallery(image1) {
    ...
    galleryImages.addEventListener("click", (e)=>{
        if (e.target.tagName === "IMG") mainImg.setAttribute("src", e.target.currentSrc);
    });
}
...
_auth.onAuthStateChanged(_app.auth, async (user)=>{
    if (user) {
        userLogged = user;
        console.log(user);
        cart = await _cartJs.getFirebaseCart(_app.db, userLogged.uid);
        console.log(cart);
    } else cart = _utils.getMyLocalCart();
    loadProduct();
});

},{"./app":"bAabt","firebase/auth":"drt1f","./getProduct":"9obnC","../functions/cart.js":"b7GtJ","../utils":"jxTvD"}],"9obnC":[function(require,module,exports) {
...
},{"./app":"bAabt","firebase/firestore":"cJafS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b7GtJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["i4PLm","7Um7J"], "7Um7J", "parcelRequire2c23")
