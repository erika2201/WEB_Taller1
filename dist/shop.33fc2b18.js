...
})({"7yEow":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "0803988533fc2b18";
...
},{}],"kYXX8":[function(require,module,exports) {
...
function renderProducts(item) {
    ...
    <div class="product__info">
        ...
        <p class="product__price">${_utils.currencyFormat(item.price)}</p>
    </div>`;
...
function filterBy() {
    ...
    if (newOrder === "asc") filteredProducts = filteredProducts.sort((a, b)=>a.price - b.price
    );
    if (newOrder === "desc") filteredProducts = filteredProducts.sort((a, b)=>b.price - a.price
    );
    productSection.innerHTML = "";
...
},{"./app":"bAabt","../functions/products":"llPmz","../utils":"jxTvD"}],"llPmz":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7yEow","kYXX8"], "kYXX8", "parcelRequire2c23")
